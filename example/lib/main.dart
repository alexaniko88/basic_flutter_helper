...
import 'package:example/child_page.dart';
...
class _MyHomePageState extends State<MyHomePage> with SelfCancellableStreamMixin {
  int _counter = 0;
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            DisabledContent.byConnectivity(child: const Text("Connectivity content")),
            Text(
              '$_counter',
